// Agora que você fez a função que envia a temperatura de Marte, vamos utilizar essa 
// temperatura para realizar outras operações. No código abaixo, 
// temos as funções temperatureInFahrenheit e greet. 
// Elas irão utilizar a temperatura obtida pela função getMarsTemperature para realizar 
// nossas operações. Escreva a função sendMarsTemperature de forma que:
